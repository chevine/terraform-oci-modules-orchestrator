...
locals {
  ...
  # OKE
  oke_clusters_configuration = local.merged_input_configs != null ? contains(keys(local.merged_input_configs), "oke_clusters_configuration") ? local.merged_input_configs.clusters_configuration : null : null
  oke_workers_configuration  = local.merged_input_configs != null ? contains(keys(local.merged_input_configs), "oke_workers_configuration") ? local.merged_input_configs.workers_configuration : null : null
}
